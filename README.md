...
| | |
|---|---|
| **Prevent double refunds across HTTP requests** | Pass `refunded_at` from your database and the library will deny immediately. If you don't pass it, you must check it yourself. See [Integration Guide](docs/INTEGRATION_GUIDE.md#step-2--pass-refunded_at). |
